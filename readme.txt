...
6. The character at the reverse position X must be
...
This plugin helps you do custom validation to fields of Gravity Forms, Formidable Forms. Such as length, numeric value between given values, age, Latitude & Longitude......
...
* Added: pagination on blocked data list page

* Fixed: the bug of cannot show field value correclty for Formidable Forms' advanced field

* Fixed: the bug when save list

* Fixed: Cannot delete plugin under PHP 8.x

* Fixed: Warning messages under PHP 8.x
...
* Fixed: the bug of wrong position for reverse Must Be / Must Not Be rule 
